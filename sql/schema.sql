...
('stat_courses_value', 'Statistik 1: Zahl (z.B. "15")', '15'),
('stat_courses_suffix', 'Statistik 1: Suffix (z.B. "+")', '+'),
('stat_courses_label', 'Statistik 1: Beschriftung', 'Kurse pro Woche'),
('stat_years_value', 'Statistik 2: Zahl (z.B. "25")', '25'),
('stat_years_suffix', 'Statistik 2: Suffix (z.B. "+")', '+'),
('stat_years_label', 'Statistik 2: Beschriftung', 'Jahre Tanzcenter Payer'),
('stat_trainers_value', 'Statistik 3: Zahl (z.B. "100")', '100'),
('stat_trainers_suffix', 'Statistik 3: Suffix (z.B. "%")', '%'),
('stat_trainers_label', 'Statistik 3: Beschriftung', 'Ausgebildete Tanzlehrer'),
